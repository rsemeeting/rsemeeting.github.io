...
<section class="content-section" id="supporting-institutions">
  ...
  <a class="institution-card" href="https://www.se.ruhr-uni-bochum.de/">
    ...
    <span class="institution-name">Ruhr University Bochum, Chair of Software Engineering</span>
  </a>

  <a class="institution-card" href="https://www.gssi.it/">
    <img class="institution-logo" src="{{ '/assets/logos/gssi.svg' | relative_url }}" alt="Gran Sasso Science Institute">
    <span class="institution-role">Steering committee and host</span>
    <span class="institution-name">Gran Sasso Science Institute</span>
  </a>

  <a class="institution-card" href="https://www.unibg.it/">
    <img class="institution-logo" src="{{ '/assets/logos/unibg.svg' | relative_url }}" alt="University of Bergamo">
    <span class="institution-role">Steering committee</span>
    <span class="institution-name">University of Bergamo</span>
  </a>

  <a class="institution-card" href="https://www.kcl.ac.uk/">
    <img class="institution-logo" src="{{ '/assets/logos/kcl.svg' | relative_url }}" alt="King's College London">
    <span class="institution-role">Host of RSE 2023</span>
    <span class="institution-name">King's College London</span>
  </a>

  <a class="institution-card" href="https://www.uni-bremen.de/en/">
    <img class="institution-logo" src="{{ '/assets/logos/unibremen-secrs.svg' | relative_url }}" alt="University of Bremen, Software Engineering for Cognitive Robots and Systems">
    <span class="institution-role">Host of RSE 2024</span>
    <span class="institution-name">University of Bremen, Software Engineering for Cognitive Robots and Systems</span>
  </a>

  <a class="institution-card" href="https://www.sdu.dk/en">
    <img class="institution-logo" src="{{ '/assets/logos/sdu-software-engineering.svg' | relative_url }}" alt="University of Southern Denmark, Software Engineering">
    <span class="institution-role">Host of RSE 2025</span>
    <span class="institution-name">University of Southern Denmark, Software Engineering</span>
  </a>

  <a class="institution-card" href="https://www.iri.upc.edu/">
    <img class="institution-logo" src="{{ '/assets/logos/iri-csic-upc.svg' | relative_url }}" alt="Institut de Robotica i Informatica Industrial, CSIC-UPC">
